...
//#  define SIMD_V4_32_SSE2   0
//#  define SIMD_V4_32_SSE41  0
//#  define SIMD_V4_32U_SSE2  0
//#  define SIMD_V4_32U_SSE41 0
#  define SIMD_V2_32_SSE2   1
#  define SIMD_V2_32_SSE41  1

// Double precision
//#  define SIMD_V4_64_AVX    0
//#  define SIMD_V4_64U_AVX   0
#  define SIMD_V2_64_SSE2   1
#  define SIMD_V2_64_SSE41  1
#  define SIMD_V2_64U_SSE2  0
#  define SIMD_V2_64U_SSE41 0
...
namespace geometry
{
   ...
   /// </summary>
   SIMD_V2_32_ALIGN class V2f : public V2<float>
   {
   public:
      //------------------------------------------------------------------------------------------------------------------------//
   ...
   SIMD_V2_64_ALIGN class V2d : public V2<double>
   {
   public:
      union
      {
   ...
   class BoundingBoxV2f : BoundingBox<V2f>
   {
   public:
      inline BoundingBoxV2f() { }
      inline ~BoundingBoxV2f() { }
   };
}
